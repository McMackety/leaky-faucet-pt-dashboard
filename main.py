...
while True:
    ...
    if len(data) == 9:
        ...
        font.render_to(screen, (WIDTH * 0.468125, HEIGHT * 0.7), data[1], (200, 0, 0))
        font.render_to(screen, (WIDTH * 0.3625, HEIGHT * 0.062), data[8], (200, 0, 0))
        font.render_to(screen, (WIDTH * 0.31875, HEIGHT * 0.318), data[5], (200, 0, 0))
        font.render_to(screen, (WIDTH * 0.6725, HEIGHT * 0.2677), data[6], (200, 0, 0))
        font.render_to(screen, (WIDTH * 0.57125, HEIGHT * 0.40333), data[3], (200, 0, 0))
        font.render_to(screen, (WIDTH * 0.449375, HEIGHT * 0.8), data[2], (200, 0, 0))
